...
public sealed class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Resources = new()
    {
        ["en"] = new()
        {
            ...
            ["ChatPerf.ShellSubtitle"] = "simple transcript · auto-scroll + streaming",
            ["ChatPerf.Seed"] = "Seed Transcript",
            ["ChatPerf.Run"] = "Run Benchmark",
            ["ChatPerf.Stop"] = "Stop",
            ["ChatPerf.ScenarioTitle"] = "Scenario",
            ["ChatPerf.Scenario"] = "1,200 chat messages + auto-scroll + large markdown streaming payload. Runs two back-to-back stress passes and measures FPS, frame-time p95, worst frame, and slow-frame ratio.",
            ["ChatPerf.ResultsTitle"] = "Results",
            ["ChatPerf.StatusLabel"] = "Status",
            ["ChatPerf.StatusIdle"] = "Idle",
            ["ChatPerf.FirstPassLabel"] = "First Pass",
            ["ChatPerf.SecondPassLabel"] = "Second Pass",
            ["ChatPerf.DeltaLabel"] = "Pass Delta",
            ["ChatPerf.NoResults"] = "No results yet.",
            ["ChatPerf.StatusSeeded"] = "Transcript seeded with many messages. Run benchmark to record two stress passes.",
            ["ChatPerf.StatusRunningFirstPass"] = "Running first stress pass…",
            ["ChatPerf.StatusRunningSecondPass"] = "Running second stress pass…",
            ["ChatPerf.StatusCompleted"] = "Benchmark complete. Review the two passes for steady-state drift under streaming + scroll stress.",
        ...
        ["he"] = new()
        {
            ...
            ["ChatPerf.ShellSubtitle"] = "טרנסקריפט פשוט · גלילה אוטומטית + סטרימינג",
            ["ChatPerf.Seed"] = "טעינת טרנסקריפט",
            ["ChatPerf.Run"] = "הרצת בנצ׳מרק",
            ["ChatPerf.Stop"] = "עצור",
            ["ChatPerf.ScenarioTitle"] = "תרחיש",
            ["ChatPerf.Scenario"] = "1,200 הודעות צ׳אט + גלילה אוטומטית + מטען Markdown גדול בסטרימינג. מורצות שתי מדידות עומס רצופות ונמדדים FPS, זמן פריים p95, פריים גרוע ביותר ושיעור פריימים איטיים.",
            ["ChatPerf.ResultsTitle"] = "תוצאות",
            ["ChatPerf.StatusLabel"] = "סטטוס",
            ["ChatPerf.StatusIdle"] = "ממתין",
            ["ChatPerf.FirstPassLabel"] = "מעבר ראשון",
            ["ChatPerf.SecondPassLabel"] = "מעבר שני",
            ["ChatPerf.DeltaLabel"] = "פער בין המעברים",
            ["ChatPerf.NoResults"] = "אין תוצאות עדיין.",
            ["ChatPerf.StatusSeeded"] = "הטרנסקריפט נטען עם הרבה הודעות. הריצו בנצ׳מרק לשתי מדידות עומס רצופות.",
            ["ChatPerf.StatusRunningFirstPass"] = "מריץ מדידת עומס ראשונה…",
            ["ChatPerf.StatusRunningSecondPass"] = "מריץ מדידת עומס שנייה…",
            ["ChatPerf.StatusCompleted"] = "הבנצ׳מרק הושלם. בחנו את שני המעברים כדי לזהות סטייה במצב יציב תחת סטרימינג + גלילה.",
